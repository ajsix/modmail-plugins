        ...
        if member == None:
            ...
            if member.id == ctx.message.author.id:
                ...
                if reason == None:
                    ...
                    embed = discord.Embed(
                        title = "Kick",
                        description = f"{member.mention} got clapped by {ctx.message.author.mention}.",
                        color = self.blurple
                    )
                    await ctx.send(embed = embed)
                    modlog = discord.utils.get(ctx.guild.text_channels, name = "modlog")
                    ...
                    embed = discord.Embed(
                        title = "Kick",
                        description = f"{member.mention} got clapped by {ctx.message.author.mention} for {reason}",
                        color = self.blurple
                    )
                    await ctx.send(embed = embed)
                    modlog = discord.utils.get(ctx.guild.text_channels, name = "modlog")
        ...
        if member == None:
            ...
            if member.id == ctx.message.author.id:
                ...
                if reason == None:
                    ...
                    embed = discord.Embed(
                        title = "Ban",
                        description = f"{member.mention} got yeeted by {ctx.message.author.mention}.",
                        color = self.blurple
                    )
                    modlog = discord.utils.get(ctx.guild.text_channels, name = "modlog")
                    if modlog == None:
                    ...
                    embed = discord.Embed(
                        title = "Ban",
                        description = f"{member.mention} got yeeted by {ctx.message.author.mention} for {reason}",
                        color = self.blurple
                    )
                    await ctx.send(embed = embed)
                    modlog = discord.utils.get(ctx.guild.text_channels, name = "modlog")
        ...
        if member == None:
            ...
            if member.id == ctx.message.author.id:
                ...
                if reason == None:
                    ...
                    embed = discord.Embed(
                        title = "Mute",
                        description = f"{member.mention} has been taken to Brazil.",
                        color = self.blurple
                    )
                    await ctx.send(embed = embed)
                    modlog = discord.utils.get(ctx.guild.text_channels, name = "modlog")
                    ...
                    embed = discord.Embed(
                        title = "Mute",
                        description = f"{member.mention} has been taken to Brazil by {ctx.message.author.mention} for {reason}",
                        color = self.blurple
                    )
                    await ctx.send(embed = embed)
                    modlog = discord.utils.get(ctx.guild.text_channels, name = "modlog")
    ...
    async def unmute(self, ctx, member : discord.Member = None):
        if member == None:
            ...
            if role in member.roles:
                ...
                embed = discord.Embed(
                    title = "Unmute",
                    description = f"{member.mention} has been deported from Brazil.",
                    color = self.blurple
                )
                await ctx.send(embed = embed)
                modlog = discord.utils.get(ctx.guild.text_channels, name = "modlog")
